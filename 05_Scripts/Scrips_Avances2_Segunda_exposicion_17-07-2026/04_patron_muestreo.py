...
RUTA_DEPENDENCIA = Path(__file__).with_name("03_introduccion_datos_espaciales.py")

if not RUTA_DEPENDENCIA.exists():
    raise FileNotFoundError(
        "No se encontró 03_introduccion_datos_espaciales.py en la misma carpeta que este script."
    )
