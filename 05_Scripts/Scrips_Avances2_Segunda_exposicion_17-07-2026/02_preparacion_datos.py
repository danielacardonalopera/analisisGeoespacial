...
Este script:
1. carga las cuatro capas procesadas;
2. verifica CRS, geometrías y estructura;
3. convierte la variable Cu a formato numérico;
4. delimita las muestras dentro del área de estudio;
5. guarda los subconjuntos espacialmente clasificados;
6. genera la Figura 01 y la Tabla 01.
...
# ==========================================================
# 0. CARGAR LA CONFIGURACIÓN GENERAL
# ==========================================================

RUTA_CONFIG = Path(__file__).with_name("01_config.py")

if not RUTA_CONFIG.exists():
    raise FileNotFoundError(
        "No se encontró 01_config.py en la misma carpeta que este script."
    )

_config = runpy.run_path(str(RUTA_CONFIG))

RUTA_PROYECTO = _config["RUTA_PROYECTO"]
PROCESADOS = _config["PROCESADOS"]
ESTUDIO = _config["ESTUDIO"]
FIGURAS = _config["FIGURAS"]
TABLAS = _config["TABLAS"]
CRS_PROYECTO = _config["CRS_PROYECTO"]
...
RUTA_FIGURA_01 = (
    FIGURAS / "Figura_01_Delimitacion_Espacial_Area_Analisis.png"
)

RUTA_TABLA_01 = (
    TABLAS / "Tabla_01_Seleccion_Muestras_Area_Analisis.csv"
)
